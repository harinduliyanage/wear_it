<%-- 
    Document   : register
    Created on : Oct 4, 2017, 8:02:02 PM
    Author     : Harindu.sul
--%>
...
<link href="<c:url value="resours/css/bootstrap.css" />" rel="stylesheet" type="text/css" media="all" />
<!-- Custom Theme files --><c:url value="resours/css/style.css" />
<!--theme-style-->
<link href="<c:url value="resours/css/style.css" />" rel="stylesheet" type="text/css" media="all" />	
<!--//theme-style-->
...
<!--theme-style-->
<link href="<c:url value="resourscss/css/css-a/style4.css" />" rel="stylesheet" type="text/css" media="all" />	
<!--//theme-style-->
<script src="js/jquery.min.js"></script>
<!--- start-rate---->
<script src="<c:url value="resourscss/js/jstarbox.js" />"></script>
